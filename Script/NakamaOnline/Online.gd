...
signal session_changed (_nakama_session)
signal session_connected (_nakama_session)
signal socket_connected (_nakama_socket)
...
func set_nakama_session(_nakama_session: NakamaSession) -> void:
	...
	if __nakama_session and not __nakama_session.is_exception() and not __nakama_session.is_expired():
